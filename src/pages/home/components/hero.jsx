      ...
      <div className="w-full bg-slate-100 pt-[60px]">
        ...
        <div className="container mx-auto px-[15px] lg:px-0 flex flex-col lg:flex-row items-center  justify-between">
          <div>
            ...
            <div className="flex items-center h-[30px] sm:h-[55px] mb-3">
            ...
            <div className="flex items-center text-center h-[30px] sm:h-[55px] mb-5">
            ...
            <div className="flex items-center text-center h-[30px] sm:h-[55px] mb-3 ">
